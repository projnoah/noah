    ...
    <div class="page-sidebar-inner slimscroll">
        ...
        <ul class="menu accordion-menu">
            <li class="{{ request()->is(substr(route('admin.dashboard', [], false), 1)) ? 'active' : '' }}">
                <a href="@route('admin.dashboard')" class="waves-effect waves-button" data-pjax>
            ...
            <li class="droplink{{ request()->is(substr(route('admin.users.index', [], false), 1) . '*') ? ' active' : '' }}">
                ...
                <ul class="sub-menu">
                    <li><a href="@route('admin.users.index')" data-pjax>@trans('views.admin.titles.users.sub.profile')</a></li>
                </ul>
            </li>
