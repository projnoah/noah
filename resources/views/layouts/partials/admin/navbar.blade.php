                            ...
                            <li class="li-group">
                                <ul class="list-unstyled">
                                    <li class="no-link" role="presentation">
                                        ...
                                        <form action="@route('admin.change-theme-color')" method="POST" id="color-changer" class="hidden"></form>
                                    </li>
                                </ul>
                            </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                            ...
                            <img class="img-circle avatar" src="{{ Auth::user()->avatarUrl }}" width="40" height="40" alt="">
                        </a>
