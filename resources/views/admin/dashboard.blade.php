    ...
    <div class="row">
            ...
            <div class="panel info-box panel-white">
                <div class="panel-body">
                    <div class="info-box-stats">
                        <p class="counter">@stat('newUsers', 'this_month')</p>
                        <span class="info-box-title">New users this month</span>
                    </div>
                    ...
                    <div class="info-box-progress">
                        <div class="progress progress-xs progress-squared bs-n">
                            <div class="progress-bar progress-bar-success" role="progressbar"
                                 aria-valuenow="@stat('newUsersRatio', 'this_month')" aria-valuemin="0"
                                 aria-valuemax="100" style="width: @stat('newUsersRatio', 'this_month')%">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="panel info-box panel-white">
                <div class="panel-body">
                    <div class="info-box-stats">
                        <p class="counter">@stat('pageViews', 'this_month')</p>
                        <span class="info-box-title">Page views this month</span>
                    </div>
                    <div class="info-box-icon">
                        <i class="icon-eye"></i>
                    </div>
                    <div class="info-box-progress">
                        <div class="progress progress-xs progress-squared bs-n">
                            <div class="progress-bar progress-bar-info" role="progressbar"
                                 aria-valuenow="@stat('pageViewsRatio', 'this_month')" aria-valuemin="0"
                                 aria-valuemax="100" style="width: @stat('pageViewsRatio', 'this_month')%">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel info-box panel-white">
                <div class="panel-body">
                    <div class="info-box-stats">
                        ...
                        <span class="info-box-title">New emails received</span>
                    </div>
                    <div class="info-box-icon">
                    ...
                    <div class="inbox-widget slimscroll">
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ Auth::user()->avatarUrl }}" class="img-circle"
                                                                 alt=""></div>
            ...
            <div class="panel twitter-box">
                <div class="panel-body">
                    <div class="live-tile" data-mode="flip" data-speed="750" data-delay="3000">
                        ...
                        <div><h2 class="no-m">Sometimes by losing a battle you find a new way to win the war...</h2>
                            <span class="tile-date">6 April, 2015</span></div>
                    </div>
                </div>
            </div>
