...
var BlogShareMenu = function () {
    function BlogShareMenu(el) {
        _classCallCheck(this, BlogShareMenu);

        this.el = el;
        this.initEvent();
    }

    _createClass(BlogShareMenu, [{
        key: "initEvent",
        value: function initEvent() {
            ...
            $(this.el).on("mousedown", function () {
                _this.toggleShareMenu();
            });
        }
    }, {
        key: "openShareMenu",
        value: function openShareMenu() {
            var _this2 = this;
            ...
            TweenMax.to(this.toggleButton, 0.1, {
                ...
                onComplete: function onComplete() {
                    TweenMax.to(_this2.toggleButton, .8, {
                        scale: 0.6,
                        ease: Elastic.easeOut,
                        easeParams: [1.1, 0.6]
                    });
                    TweenMax.to($(_this2.toggleButton).find(".share-icon"), .8, {
                        scale: 1.4,
                        ease: Elastic.easeOut,
                        easeParams: [1.1, 0.6]
                    });
    ...
    return BlogShareMenu;
}();

exports.default = BlogShareMenu;
;

},{}],4:[function(require,module,exports){
"use strict";

var _BlogShareMenu = require("./classes/BlogShareMenu");

var _BlogShareMenu2 = _interopRequireDefault(_BlogShareMenu);
    ...
    vm: function vm() {
        return _vm ? _vm : new Vue({
            ...
            methods: {
                ...
                searchQuery: function searchQuery(ev) {
                    var form = ev.target,
...
$(document).ready(function () {
    ...
    // Blog share menus
    var shareEl = $(blogItems).children(".blog-share");
    $(shareEl).each(function () {
        new _BlogShareMenu2.default(this);
    });
    ...
    $(blogItems).each(function () {
        ...
        $(this).waypoint(function (direction) {
            if (!_vm.isTopMenuOpen) {
                var avatar = $(_this).find(".blog-avatar")[0];
        ...
        $(this).waypoint(function (direction) {
            ...
            if (!!$(_this).prev().length && !_vm.isTopMenuOpen) {
                var prev = $(_this).prev()[0],
...
},{"./classes/BlogShareMenu":3,"vue":2}],5:[function(require,module,exports){
"use strict";
...
!function () {
  ...
  function t(n) {
    this.options = i.extend({}, t.defaults, n), this.container = this.options.element, "auto" !== this.options.container && (this.container = this.options.container), this.$container = i(this.container), this.$more = i(this.options.more), this.$more.length && (this.setupHandler(), this.waypoint = new o(this.options));
      ...
      o = window.Waypoint;t.prototype.setupHandler = function () {
    this.options.handler = i.proxy(function () {
      this.options.onBeforePageLoad(), this.destroy(), this.$container.addClass(this.options.loadingClass), i.get(i(this.options.more).attr("href"), i.proxy(function (t) {
        var n = i(i.parseHTML(t)),
            ...
            s = n.find(this.options.items);s.length || (s = n.filter(this.options.items)), this.$container.append(s), this.$container.removeClass(this.options.loadingClass), e.length || (e = n.filter(this.options.more)), e.length ? (this.$more.replaceWith(e), this.$more = e, this.waypoint = new o(this.options)) : this.$more.remove(), this.options.onAfterPageLoad(s);
      }, this));
    }, this);
  }, t.prototype.destroy = function () {
    this.waypoint && this.waypoint.destroy();
  }, t.defaults = { container: "auto", items: ".infinite-item", more: ".infinite-more-link", offset: "bottom-in-view", loadingClass: "infinite-loading", onBeforePageLoad: i.noop, onAfterPageLoad: i.noop }, o.Infinite = t;
}();
